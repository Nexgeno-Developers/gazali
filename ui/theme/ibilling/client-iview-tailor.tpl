					...
					<div class="row">
						<div class="col-sm-6 mt-md">
							...
							<div class="bill-to" style="font-size:12px;">
								<p class="h5 mb-xs text-dark text-semibold"><strong>Customer Name:</strong></p>
								<address style="margin:0px">
										...
										<p class="mb-none">
											<span class="text-dark"><b>{$_L['Invoice Date']}:</b></span>
											<span class="value">{date( $_c['df'], strtotime($d['date']))}</span>
									</p>
									<p class="mb-none">
											<span class="text-dark"><b>Delivery Date:</b></span>
							...
							<div class="col-md-6">
								<div class="bill-data text-right">
									...
									<!--<form class="form-inline" method="post" action="{$_url}client/ipay/{$d['id']}/token_{$d['vtoken']}">
										...
										<input type="hidden" name="productinfo" value="{$d['invoicenum']}">
										...
										<input type="hidden" name="key" value="9FmthAKe">
