                ...
                <form class="form-horizontal" id="rform">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group hide"><label class="col-md-4 control-label" for="city">{$_L['City']}</label>

                                <div class="col-lg-8"><input type="text" id="city" name="city" class="form-control">

                                </div>
                            </div>
                            <div class="form-group hide"><label class="col-md-4 control-label" for="state">{$_L['State Region']}</label>
                            ...
                            <div class="form-group hide"><label class="col-md-4 control-label" for="country">{$_L['Country']}</label>
                                    ...
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        {$countries}
														...
														<div class="form-group">
															<label class="col-md-4 control-label" for="country">{$_L['gst']}</label>
                              <div class="col-lg-8">
                                <input type="text" id="gst" name="gst" class="form-control">
                              </div>
                            </div>														
															<div class="form-group">
															<label class="col-md-4 control-label" for="country">PAN</label>
                              <div class="col-lg-8">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group hide"><label class="col-md-4 control-label" for="currency">{$_L['Currency']}</label>
                                    ...
                                    <select name="branch_id" id="branch_id" class="form-control" required>
                                        {if $user->roleid eq 0}
                                            ...
                                            {foreach $branches as $branch}
                                                <option value="{$branch.id}" {if $branch.id eq $user->branch_id}selected{/if}>{$branch.alias}</option>
                                            {/foreach}
                                        {else}
                                            {foreach $branches as $branch}
                            ...
                            *}
                            ...
                            <div class="form-group hide"><label class="col-md-4 control-label" for="send_client_signup_email">{$_L['Welcome Email']}</label>
